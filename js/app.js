...
const VERSAO_ATUAL = "v0.161.0 - versão alpha";
...
// 3. Configuração do Container de Chat (Fixo, respeitando as bordas apenas no PC)
const ehPc = window.innerWidth > 768;
telaChat.style.display = "flex";
telaChat.style.flexDirection = "column";
telaChat.style.position = "fixed";
if (ehPc) {
    telaChat.style.top = "20px";
    telaChat.style.bottom = "20px";
    telaChat.style.left = "50%";
    telaChat.style.transform = "translateX(-50%)";
    telaChat.style.width = "650px";
    telaChat.style.height = "calc(100vh - 40px)";
    telaChat.style.borderRadius = "16px";
    telaChat.style.border = "1px solid #262626";
    telaChat.style.boxShadow = "0 10px 30px rgba(0,0,0,0.8)";
} else {
    ...
    telaChat.style.borderRadius = "0";
    telaChat.style.border = "none";
    telaChat.style.boxShadow = "none";
}
...
const syncViewport = () => {
    ...
    if (vv && telaChat.style.display !== "none" && !window.innerWidth > 768) {
